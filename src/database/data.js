export const skillsFrontend = [
    {
        logoUrl: './src/img/tecnologias/html-icon.svg',
        name: 'HTML',
        category: 'frontend', 
    }, 
    
    {
        logoUrl: './src/img/tecnologias/css-icon.svg',
        name: 'CSS',
        category: 'frontend', 
    }, 
    ...
    {
        logoUrl: './src/img/tecnologias/react-icon.svg',
        name: 'REACT',
        category: 'frontend', 
    }, 
    ...
    {
        logoUrl: './src/img/tecnologias/figma-icon.svg',
        name: 'FIGMA',
        category: 'frontend', 
    }, 
]
...
export const skillsBackend = [
    {
        logoUrl: './src/img/tecnologias/node-icon.svg',
        name: 'NODEJS',
        category: 'backend', 
    }, 
    ...
    {
        logoUrl: './src/img/tecnologias/git-icon.svg',
        name: 'GIT',
        category: 'backend', 
    }, 

    {
        logoUrl: './src/img/tecnologias/github-icon.svg',
        name: 'GITHUB',
        category: 'backend', 
    }, 
]
...
export const skillsLowCode = [
    {
        ...
        name: 'Micro-Certification<br>Welcome to ServiceNow',
        category: 'lowcode'
    },
...
export const xpProfessional = [
    ...
    {
        logoUrl: './src/img/experiences/unanime-icon.svg',
        nameCompany: 'UNÂNIME',
        occupation: 'Analista de suporte Help Desk',
        timeStart: '2019 ',
        timeEnd: '2021',
    },
    
    {
        logoUrl: './src/img/experiences/gbsantos-icon.png',
        nameCompany: 'MERCANTIL GB SANTOS',
    ...
    {
        logoUrl: './src/img/experiences/bancodobrasil-icon.jpg',
        nameCompany: 'BANCO DO BRASIL',
